...
export let instance: LAppWavFileHandler = null;
...
export class LAppWavFileHandler {
  ...
  public static getInstance(): LAppWavFileHandler {
    if (instance == null) {
      instance = new LAppWavFileHandler();
    }
  ...
  public start(arrayBuffer: ArrayBuffer): void {
    // サンプル位参照位置を初期化
  ...
  public loadWavFile(arrayBuffer: ArrayBuffer): Promise<boolean> {
    return new Promise(resolveValue => {
      ...
      const asyncWavFileManager = (async () => {
        ...
        // ファイル名
        this._wavFileInfo._fileName = 'wavfilename';
